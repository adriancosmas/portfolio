...
import { cibReact, cibNextJs, cibTypescript, cibJavascript } from '@coreui/icons';

const LOGOS = [
  <CIcon icon={cibReact} className='w-20 h-20'/>,
  <CIcon icon={cibNextJs} className='w-20 h-20'/>,
  <CIcon icon={cibTypescript} className='w-20 h-20'/>,
  <CIcon icon={cibJavascript} className='w-20 h-20'/>,
]
